...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    CONSTRAINT = 259,              /* CONSTRAINT  */
    INTEGER = 260,                 /* INTEGER  */
    COMMA = 261,                   /* COMMA  */
    OPEN_PAREN = 262,              /* OPEN_PAREN  */
    CLOSE_PAREN = 263,             /* CLOSE_PAREN  */
    IDENTIFIER = 264,              /* IDENTIFIER  */
    CREATE_TABLE = 265,            /* CREATE_TABLE  */
    PRIMARY_KEY = 266,             /* PRIMARY_KEY  */
    REFERENCES = 267,              /* REFERENCES  */
    FOREIGN_KEY = 268,             /* FOREIGN_KEY  */
    NOT_NULL = 269,                /* NOT_NULL  */
    DATE = 270,                    /* DATE  */
    NUMBER = 271,                  /* NUMBER  */
    CHAR = 272,                    /* CHAR  */
    VARCHAR = 273,                 /* VARCHAR  */
    VARCHAR2 = 274                 /* VARCHAR2  */
  };
